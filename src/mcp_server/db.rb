...
module NotaKnowledgeBase
  module DB
    ...
    # Where the downloaded index lives. See Config.knowledge_db_path, which is
    # where this is decided -- the SessionStart hook has to agree with us and
    # cannot require this file, since it runs before Bundler and sqlite3 exist.
    def default_db_path
